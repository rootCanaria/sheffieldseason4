...
function resourceStart(resource)
	...
	setRuleValue("Author", "Sheffield-MTA Server Development Team")
	setRuleValue("Website", "Soon")
	setGlitchEnabled ( "baddrivebyhitbox", false )
	setFPSLimit(70) -- 72 is the real max before issues arise
...
function makeOwlName(thePlayer)
	setPlayerName(thePlayer, "Player.Loading."..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9)))
end
