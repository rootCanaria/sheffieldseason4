...
function frames_showTexGUI ( )
	...
	if (interiorID > 0 and interiorWorld > 0) or (exports.integration:isPlayerSeniorAdmin(localPlayer) and exports.global:isAdminOnDuty(localPlayer)) or (exports.integration:isPlayerScripter(localPlayer) and exports.global:isStaffOnDuty(localPlayer)) then
		if (interiorID < 20000 and exports.global:hasItem(localPlayer, 4, interiorID)) or (interiorID < 20000 and exports.global:hasItem(localPlayer, 5, interiorID)) or (interiorID > 20000 and exports.global:hasItem(localPlayer, 3, interiorID-20000)) or (exports.integration:isPlayerSeniorAdmin(localPlayer) and exports.global:isAdminOnDuty(localPlayer)) or (exports.integration:isPlayerScripter(localPlayer) and exports.global:isStaffOnDuty(localPlayer)) or (interiorID == 0) then
