...
function frames_showTextureSelection ( slot, textureURL, imgData )
	...
	if (dimension > 0 and interior > 0) or (integration:isPlayerSeniorAdmin(localPlayer) and global:isAdminOnDuty(localPlayer)) or (integration:isPlayerScripter(localPlayer) and global:isStaffOnDuty(localPlayer)) then
		if (dimension < 20000 and exports.global:hasItem(localPlayer, 4, dimension)) or (dimension < 20000 and exports.global:hasItem(localPlayer, 5, dimension)) or (dimension > 20000 and exports.global:hasItem(localPlayer, 3, dimension-20000)) or (exports.integration:isPlayerSeniorAdmin(localPlayer) and exports.global:isAdminOnDuty(localPlayer)) or (exports.integration:isPlayerScripter(localPlayer) and exports.global:isStaffOnDuty(localPlayer)) or (dimension == 0) or (interior == 0) then
