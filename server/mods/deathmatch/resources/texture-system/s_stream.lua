...
addEventHandler("frames:delete", resourceRoot,
	function(id, interior, dimension)
		...
		if (dimension > 0 and interior > 0) or (exports.integration:isPlayerSeniorAdmin(client) and exports.global:isAdminOnDuty(client)) or (exports.integration:isPlayerScripter(client) and exports.global:isStaffOnDuty(client)) then
			if (dimension < 20000 and exports.global:hasItem(client, 4, dimension)) or (dimension < 20000 and exports.global:hasItem(client, 5, dimension)) or (dimension > 20000 and exports.global:hasItem(client, 3, dimension-20000)) or (exports.integration:isPlayerSeniorAdmin(client) and exports.global:isAdminOnDuty(client)) or (exports.integration:isPlayerScripter(client) and exports.global:isStaffOnDuty(client)) or (dimension == 0) then
...
function newTexture(source, url, texture, interior, dimension)
	...
	if (dimension > 0 and interior > 0) or (exports.integration:isPlayerSeniorAdmin(source) and exports.global:isAdminOnDuty(source)) or (exports.integration:isPlayerScripter(source) and exports.global:isStaffOnDuty(source)) then
		if (dimension < 20000 and exports.global:hasItem(source, 4, dimension)) or (dimension < 20000 and exports.global:hasItem(source, 5, dimension)) or (dimension > 20000 and exports.global:hasItem(source, 3, dimension-20000)) or (exports.integration:isPlayerSeniorAdmin(source) and exports.global:isAdminOnDuty(source)) or (exports.integration:isPlayerScripter(source) and exports.global:isStaffOnDuty(source)) or (dimension == 0) then
...
addEventHandler("frames:deleteAll", resourceRoot,
    function(  )
        ...
        if global:hasItem(client, 4, interior) or global:hasItem(client, 5, interior) or (integration:isPlayerSeniorAdmin(client) and global:isAdminOnDuty(client)) or (interior==0) then
