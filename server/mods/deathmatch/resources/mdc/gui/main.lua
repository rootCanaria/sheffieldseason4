...
function main ( warrants, apb, impounds, calls, anpr )
	closeMainW()
	--outputChatBox( "لغلق اللوحة يمكنك الضغط علي زر F5", 255, 0, 0 )
	...
	local active_faction, level, can = canAccess( localPlayer, 'canSeeWarrants' )
		...
		, false )
		mainW.searchButtonImage = guiCreateStaticImage ( 5, 5, 40, 40, ":mdc/img/tolls.png", false, mainW.tollsButton )
	...
	mainW.closeButton = guiCreateButton( 10, height - 60, width - 20, 40, "Close", false, mainW.window )
