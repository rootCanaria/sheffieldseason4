...
function startWizard_1()
	if (getElementData(localPlayer, 'hoursplayed') or 0) < 1 then
		playSoundFrontEnd(4)
		outputChatBox("You must have played at least one hour on this character or activate '"..exports.donators:getPerks(32)[1].."' perk to submit a new design.", 255,0,0)
...
function startWizard_2()
	...
	GUIEditor2.label[2] = guiCreateLabel(10, 73, 302, 18, "Example: http://i.imgur.com/MG9pkfl.png; Maximum filesize: 200KB", false, GUIEditor2.window[1])
