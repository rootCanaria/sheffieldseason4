...
local arenas = {
	[1] = { "LikeMike's Car Cemetery", 0, 2299, positions = {
			[1] = { -64.46349, 1887.24988, 17.22656 },
			[2] = { -66.75216, 1887.71814, 17.22656 },
			[3] = { -66.67011, 1889.93262, 17.22656 },
			[4] = { -66.67011, 1889.93262, 17.22656 },
			[5] = { -64.07903, 1889.90491, 17.22656 },
			
			[6] = { -13.63802, 2054.42725, 17.78691 },
			[7] = { -10.93281, 2054.41724, 17.78659 },
			[8] = { -11.02217, 2052.31079, 17.71969 },
			[9] = { -13.54294, 2052.32007, 17.71999 },
			[10] = { -12.19172, 2050.17554, 17.65187 },
			
		},
	},
	
	[2] = { "MindScape's Battlefield", 0, 2310, positions = {
			[1] = { 1101.95886, 1300.95654, 10.82031 },
			[2] = { 1105.31360, 1300.47510, 10.82031 },
			[3] = { 1108.37695, 1300.02551, 10.82031 },
			[4] = { 1106.20544, 1297.45276, 10.82031 },
			[5] = { 1102.80505, 1296.09924, 10.82031 },
	
			[6] = { 1173.79858, 1214.89062, 10.81252 },
			[7] = { 1173.72253, 1212.85083, 10.81252 },
			[8] = { 1171.59668, 1216.62939, 10.82031 },
			[9] = { 1170.79590, 1214.47156, 10.81252 },
			[10] = { 1170.90417, 1212.14697, 10.81252  },
		},
	},
	
	[3] = { "Battlefield's Arena", 0, 2313, positions = {
			[1] = { 520.09186, -3915.14771, 8.90695 },
			[2] = { 518.91852, -3914.76538, 8.90695 },
			[3] = { 517.74500, -3914.58081, 8.90695 },
			[4] = { 516.24969, -3914.58643, 8.90695 },
			[5] = { 517.78687, -3912.90527, 8.90695 },
			
			[6] = { 494.90872, -3774.26074, 14.23702 },
			[7] = { 496.96222, -3776.75098, 14.19333 },
			[8] = { 497.09091, -3774.85596, 14.22658 },
			[9] = { 494.85855, -3776.80444, 14.19239 },
			[10] = { 492.66443, -3776.65674, 14.19498 },
		},
	},
...
addEventHandler("event:getPaintballGUI", getRootElement(), function(interact)
	...
	if #matches[lobby].players < MATCH_PLAYERS and matches[lobby].state == 0 then
		if not exports.global:takeMoney(source, 50) then --change back to 50
...
addEventHandler("event:readyPlayer", getRootElement(), function(lobby)
	for index, value in ipairs(matches[lobby].players) do
		...
		allReady = (#matches[lobby].players >= 2 and allReady) or false
...
--Paintball
if getElementData(localPlayer, "paintball:1,paintball,paintball:2,paintball:3,paintball:4") == 2 then
