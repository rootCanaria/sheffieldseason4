...
local PD_VEHICLES = { 427, 44, 528, 523, 598, 596, 597, 599, 601 }
PD_ID = 1
FAA_ID = 47
GOV_ID = 3
SASD_ID = 59
RT_ID = 4
local FAA_VEHICLES = { 596, 44, 426 }
local FAA_INTERIORS = {}
...
function hasMDCPermissions( )
	if isPedInVehicle( localPlayer ) then
		...
		elseif(vehicle == 596 or vehicle == 427 or vehicle == 44 or vehicle == 599 or vehicle == 601 or vehicle == 523 or vehicle == 597 or vehicle == 598 or exports.global:hasItem(vehicle, 143)) then
			return true
		else
			return false
		end
...
------------------------------------------
--if (exports.global:hasItem(thePlayer, 143)) then
