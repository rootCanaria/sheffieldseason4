...
function sendDiscordLogMessage(message)
    ...
    fetchRemote ( "https://discord.com/api/webhooks/973640980874022964/9mgVSX0UadHyZLvLuKG0MdHA-NvbA_f6zWKhXRx5xJ_EZOI7nEe6iRynKNMMCacwHIno", sendOptions, SheffAds)
end
local shsend = sendDiscordLogMessage("> By: (("..advertisement.name:gsub("_", " ").."))\n> Type: (("..sectionnames1.."))\n> Address: (("..advertisement.address.."))\n> Phone: #"..advertisement.phone.."\n> ADVERT: "..advertisement.advertisement.."")
