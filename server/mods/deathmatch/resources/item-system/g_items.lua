g_items = {
	...
	[38] = { "Marijuana", "Green, good tasting weed.", 3, 1578, 0, 0, 0, 0.04, weight = 0.1 },
	...
	[159] = { "Na Vina Inc. ID", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.3}, -- 159 | Na Vina Inc. ID
	...
	[245] = { "E-Buy Company ID", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.3 }, --Exciter
...
function getBadges( )
	return {
		...
		[159] = { "Na Vina Inc. ID", "An ID from Na Vina Inc.", {[225] = true},  {52, 152, 219}, 1}, -- anumaz, Cargo Group ID
		...
		[245] = { "E-Buy Company ID", "a E-Buy Company ID", {[56] = true}, {255, 127, 0}, 1},
