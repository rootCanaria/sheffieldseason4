...
local panel = {
		...
		register = {},
		sounds = {
			{ 'https://j.top4top.io/m_230924sts1.mp3', 0.3 },
			{ 'https://j.top4top.io/m_230924sts1.mp3', 0.3 },
			{ 'https://j.top4top.io/m_230924sts1.mp3', 0.3 },
		}
	}
...
function open_log_reg_pannel()
	if not isElement ( panel.login.main ) then
		...
		panel.login.logo = guiCreateStaticImage( (sw-logoSize[1])/2, (sh-logoSize[2])/2 , logoSize[1], logoSize[2], "/login-panel/", false )
		...
		setTimer( fade.login, 1, 1 , (sw+Width)/2 )
